            ...
            errorMessage = (
                <div>
                    <FormattedMessage
                        ...
                        defaultMessage='Iconloop was unable to load because a setting in your browser prevents the use of its local storage features. To allow Iconloop to load, try the following actions:'
                    />
                    <ul>
                        <li>
                            <FormattedMessage
                ...
                <div>
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage='For {link} make sure the administrator of your Microsoft organization has enabled the Iconloop app.'
                            values={{
                                link: (
                                    <ErrorLink
            ...
            errorMessage = (
                <p>
                    <FormattedMessage
                        ...
                        defaultMessage='You must authorize Iconloop to log in with {service}.'
                        values={{
                            service,
                        }}
                    />
