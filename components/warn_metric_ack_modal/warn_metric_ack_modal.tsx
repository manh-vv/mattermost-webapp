...
export default class WarnMetricAckModal extends React.PureComponent<Props, State> {
    ...
    renderContactUsError = () => {
        ...
        const mailSubject = 'Iconloop Contact Us request';
        let mailBody = 'Iconloop Contact Us request.';
        if (this.props.warnMetricStatus.id === WarnMetricTypes.SYSTEM_WARN_METRIC_NUMBER_OF_ACTIVE_USERS_500) {
            mailBody = 'Iconloop Contact Us request.\r\nMy team now has 500 users, and I am considering Iconloop Enterprise Edition.';
        ...
        if (this.props.warnMetricStatus.id === WarnMetricTypes.SYSTEM_WARN_METRIC_NUMBER_OF_ACTIVE_USERS_500) {
            headerTitle = (
                <FormattedMessage
                    ...
                    defaultMessage='Scaling with Iconloop'
                />
            );
        } else if (this.props.warnMetricStatus.id === WarnMetricTypes.SYSTEM_WARN_METRIC_NUMBER_OF_POSTS_2M) {
            headerTitle = (
        ...
        if (this.props.warnMetricStatus.id === WarnMetricTypes.SYSTEM_WARN_METRIC_NUMBER_OF_ACTIVE_USERS_500) {
            descriptionText = (
                <FormattedMessage
                    ...
                    defaultMessage='Iconloop strongly recommends that deployments of over {limit}} users take advantage of features such as user management, server clustering, and performance monitoring. Contact us to learn more and let us know how we can help.'
                    values={{
            ...
            descriptionText = (
                <FormattedMessage
                    ...
                    defaultMessage='Your Iconloop system has a large number of messages. The default Iconloop database search starts to show performance degradation at around 2.5 million posts. With over 5 million posts, Elasticsearch can help avoid significant performance issues, such as timeouts, with search and at-mentions. Contact us to learn more and let us know how we can help.'
                    values={{
                        limit: this.props.warnMetricStatus.limit,
                    }}
                />
        ...
        const subText = (
            ...
            >
                <FormattedMessage
                    ...
                    defaultMessage='By clicking Acknowledge, you will be sharing your information with Iconloop Inc. {link}'
                    values={{
                        link: (
                            <ErrorLink
                                url={learnMoreLink}
