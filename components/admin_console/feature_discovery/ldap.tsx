...
const LDAPFeatureDiscovery: React.FC = () => {
    return (
        <FeatureDiscovery
            ...
            titleDefault='Integrate Active Directory/LDAP with Iconloop Enterprise E10'
            copyID='admin.ldap_feature_discovery.copy'
            copyDefault={'When you connect Iconloop with your organization\'s Active Directory/LDAP, users can log in without having to create new usernames and passwords.'}
