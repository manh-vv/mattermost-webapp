        ...
        if (this.state.extendSessionLengthWithActivity) {
            sessionLengthWebHelpText = (
                <FormattedMessage
                    ...
                    defaultMessage='Set the number of days from the last activity in Iconloop to the expiry of the user’s session when using email and AD/LDAP authentication. After changing this setting, the new session length will take effect after the next time the user enters their credentials.'
                />
            );
            sessionLengthMobileHelpText = (
                <FormattedMessage
                    id='admin.service.mobileSessionDaysDesc.extendLength'
                    defaultMessage='Set the number of days from the last activity in Iconloop to the expiry of the user’s session on mobile. After changing this setting, the new session length will take effect after the next time the user enters their credentials.'
                />
            );
            sessionLengthSSOHelpText = (
                <FormattedMessage
                    id='admin.service.ssoSessionDaysDesc.extendLength'
                    defaultMessage='Set the number of days from the last activity in Iconloop to the expiry of the user’s session for SSO authentication, such as SAML, GitLab and OAuth 2.0. If the authentication method is SAML or GitLab, the user may automatically be logged back in to Iconloop if they are already logged in to SAML or GitLab. After changing this setting, the setting will take effect after the next time the user enters their credentials.'
                />
            );
        } else {
            sessionLengthWebHelpText = (
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, sessions will be automatically extended when the user is active in their Iconloop client. Users sessions will only expire if they are not active in their Iconloop client for the entire duration of the session lengths defined in the fields below. When false, sessions will not extend with activity in Iconloop. User sessions will immediately expire at the end of the session length or idle timeouts defined below. '
                        />
                    }
